        ...
        <form action={formAction} onSubmit={handleSubmit}>
            <div className="bg-white p-8 flex flex-col rounded-md border-black">
                ...
                <div className="flex flex-col md:flex-row mt-4">
                    ...
                    <textarea className="md:ml-16 w-full md:w-80 bg-slate-100 rounded-sm px-2 py-1" placeholder="Tell us if you are a parent, young adult, or counselor " id="message" name="message" value ={formData.message} onChange={handleTextChange} />
                </div>
