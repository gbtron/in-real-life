        ...
        <section className="relative pb-64 overflow-hidden">
          ...
          <div className="relative flex pl-8 sm:px-[--columnPaddingNormal] sm:mx-auto sm:max-w-[calc(var(--columnPaddingNormal)*2+var(--layoutWidthMax))]">
              <div className= "w-3/4 sm:w-1/2 sm:pr-44 pt-16 text-slate-600">
                <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-heading font-semibold">Where real connections happen </h1>
                <div className="pt-12 text-lg font-serif">
              ...
              <Image src="/assets/back-view-people-looking-distance.jpg" alt="Back view of people looking in distance" width={580} height={400} className="sepia-[.3] rounded-lg h-[36rem] hidden sm:block mt-12"/>
          ...
          <div className="text-slate-600 pb-40 pl-8 sm:px-[--columnPaddingNormal] sm:mx-auto sm:max-w-[calc(var(--columnPaddingNormal)*2+var(--layoutWidthMax))]">
            ...
            <div className="flex pt-20 sm:pt-40">
              <div className="lg:pt-20 w-3/4 sm:w-2/3">
                <h1 className="pt-6 font-heading text-indigo-600 font-semibold text-xl sm:text-3xl">Holistic offerings</h1>
                <div className="text-4xl sm:text-7xl font-heading pt-8 font-semibold">
              ...
              <Image src="/assets/bridge.jpg" alt="Man walking on bridge" width={600} height={400} className="rounded-lg hidden sm:block sepia-[.3] w-[1/2] h-[40rem] ml-20"/>
            </div>
            
            <div className="pt-40">
              <h1 className="text-lg">Events</h1>
              <div className="text-3xl font-heading pt-6 font-semibold">
                Active Community
              </div>
              <div className="pt-8 text-lg font-serif w-3/4 sm:w-1/3">
            ...
            <div className="pt-40">
              ...
              <div className="pt-8 text-lg font-serif w-3/4 sm:w-1/3">Develop independent living skills and social skills, such as effective communication, networking, and conflict resolution.</div>
            </div>
        ...
        <section className="overflow-hidden bg-indigo-900 text-slate-100" >
          <div className="relative flex pl-8 sm:px-[--columnPaddingNormal] sm:mx-auto sm:max-w-[calc(var(--columnPaddingNormal)*2+var(--layoutWidthMax))]">
            <div className="pt-20 w-3/4 sm:w-2/3">
              ...
              <Link href="/contact">
                <div className="hover:bg-indigo-800 hover:text-slate-100 bg-slate-100 group text-slate-900 py-2 mt-8 px-4 rounded-full w-32 mb-10">
                  Contact us
                </div>
              </Link>
            </div>
            <Image src="/assets/flower.jpg" alt="Yellow flower spiral" width={600} height={400} className="rounded-lg hidden sm:block sepia-[.3] w-[1/2] h-[26rem] ml-20 my-20"/>
          </div>
        </section>
      </div>
    </main>
